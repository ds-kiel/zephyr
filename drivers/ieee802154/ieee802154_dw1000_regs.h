...
#define DWT_RX_FQUAL_FP_AMPL2_OFFSET 2
#define DWT_RX_FQUAL_FP_AMPL2_LEN 2
#define DWT_RX_FQUAL_FP_AMPL3_OFFSET 4
#define DWT_RX_FQUAL_FP_AMPL3_LEN 2
#define DWT_RX_FQUAL_FP_CIR_PWR_OFFSET 6
#define DWT_RX_FQUAL_FP_CIR_PWR_LEN 2
